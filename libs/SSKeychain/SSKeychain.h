...
+ (NSString *)accountForService:(NSString *)serviceName error:(NSError **)error;
+ (BOOL)deleteAccount:(NSString *)account serviceName:(NSString *)serviceName;
+ (BOOL)deleteAccount:(NSString *)account serviceName:(NSString *)serviceName error:(NSError **)error;
...
+ (BOOL)setAccount:(NSString *)account forService:(NSString *)serviceName error:(NSError **)error;
